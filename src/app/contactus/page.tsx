    ...
    <section className="py-24 mt-20">
        <div className="max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5 flex flex-col md:flex-row gap-16">
            <div className="flex md:flex-1">
                <Image src="/contactus.jpg" alt="creative agency " width={1300} height={900} className="w-full md:h-full object-cover rounded-lg" />
            </div>
            <div className="md:w-1/2 space-y-12 text-gray-700 dark:text-gray-300 md:py-8">
                ...
                <p>
                We're here to help with any questions or feedback you may have. Whether you're seeking assistance in finding the perfect dog breed, need support with our website, or simply want to share your thoughts, we're all ears! Reach out to us through the form below, and our dedicated team will respond promptly. Your satisfaction and experience with DogBreed Finder matter to us, and we're committed to providing you with the best support possible.
                </p>
