...
export async function POST(req) {
  try {
    ...
    const response = await fetch("https://www.nyckel.com/v1/functions/755qwury0xy9wz2j/invoke", {
      headers: {
    ...
    return new Response(JSON.stringify({ status: "success", img:imgurl, result:data }), {
      status: 200,
      headers: {
        'Content-Type': 'application/json'
      }
